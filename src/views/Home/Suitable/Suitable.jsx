...
export default function Suitable() {
    return (
        <div className="suitable flex justify-between items-center max-w-[1096px] mx-auto">
            <Fade delay={500} direction='up' triggerOnce >
                <div className="flex justify-center mb-10">
                    <img src="/icons/Group 7953.png" alt="#" />
                </div>
            </Fade>
            <Fade delay={500} direction='up' triggerOnce >
                <div className="sm:w-[427px] pr-4">
                    ...
                    <p className="text-[16px] text-[#505e81] mb-6">ما در حال حاضر برای افراد یا گروه هایی که دارای کالاهای فیزیکی هستند قادر به ارائه خدمات هستیم</p>
            ...
            <Fade delay={500} direction='up' triggerOnce >
                <div className="suitableimg">
                    <img src="/icons/Group 7954.png" alt="#" />
                </div>
            </Fade>
        </div>
    )
